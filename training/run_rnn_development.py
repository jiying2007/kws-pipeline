...
def main() -> int:
    ...
    # run_gru_development contains the shared, already-governed acoustic-rotation
    # and negative-stress implementation. Bind its hook to the independent RNN
    # iterator so the real RNN development renderer, not the GRU iterator, is patched.
    shared.loop = loop
